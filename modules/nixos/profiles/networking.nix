...
with lib;
{
  ...
  config = mkIf cfg.enable {
    ...
    services = {
      ...
      #   #   settings = {
      #   #     password = "test";
      #   #     certificate = "/etc/secrets/rkvm-certificate.pem";
      #   #     server = "10.1.2.28:5258";
      #   #   };
      #   # };
      #   server = {
      #     enable = true;
      #     settings.password = "test";
      #     settings.certificate = "/etc/secrets/rkvm-certificate.pem";
      #     settings.key = "/etc/secrets/rkvm-key.pem";
      #   };
      # };
    ...
    users.users.orual.extraGroups = [ "networkmanager" ];
  };
}
